...
export const Level4SceneLayers = {
	PRIMARY: "PRIMARY",
...
export default class Level4Scene extends HW4Scene {
    ...
    public startScene() {
        ...
        const unpause = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.PAUSE, {position: new Vec2(center.x - 5, center.y - 210), text: ""});
        ...
        const mainMenu = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.PAUSE, {position: new Vec2(center.x - 5, center.y + 223), text: ""});
        ...
        const controlsButton = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.PAUSE, {position: new Vec2(center.x - 5, center.y - 65), text: ""});
        ...
        const helpButton = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.PAUSE, {position: new Vec2(center.x - 5, center.y + 80), text: ""});
        ...
        const controlsBackButton = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.CONTROLS, {position: new Vec2(center.x - 595, center.y + 415), text: ""});
        ...
        const helpBackButton = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.HELP, {position: new Vec2(center.x - 595, center.y + 415), text: ""});
        ...
        const completeButton = this.add.uiElement(UIElementType.BUTTON, Level4SceneLayers.COMPLETE, {position: new Vec2(center.x, center.y + 475), text: ""});
...
protected initLayers(): void {
    ...
    this.addLayer(Level4SceneLayers.UI);
    this.addLayer(Level4SceneLayers.PAUSE, 10);
    this.addLayer(Level4SceneLayers.HELP, 11);
    this.addLayer(Level4SceneLayers.CONTROLS, 11);
    this.addLayer(Level4SceneLayers.COMPLETE, 12);
