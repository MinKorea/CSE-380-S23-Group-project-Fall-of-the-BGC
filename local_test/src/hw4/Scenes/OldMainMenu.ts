...
export const OldMainMenuLayers = {
	PRIMARY: "PRIMARY",
...
export default class OldMainMenu extends Scene {
    ...
    public loadScene(){
        this.load.image(OldMainMenu.BACKGROUND_KEY, OldMainMenu.BACKGROUND_PATH);
    }
    ...
    public startScene(){
        ...
        this.addLayer(OldMainMenuLayers.BACKGROUND, 0);
		this.initBackground();

        this.addLayer(OldMainMenuLayers.PRIMARY, 5);

        // The main menu
        // this.mainMenu = this.addUILayer("mainMenu");

        const play = this.add.uiElement(UIElementType.BUTTON, OldMainMenuLayers.PRIMARY, {position: new Vec2(center.x + 2, center.y + 335), text: ""});
        ...
        const help = this.add.uiElement(UIElementType.BUTTON, OldMainMenuLayers.PRIMARY, {position: new Vec2(center.x + 242, center.y + 230), text: ""});
        ...
        const controls = this.add.uiElement(UIElementType.BUTTON, OldMainMenuLayers.PRIMARY, {position: new Vec2(center.x - 238, center.y + 230), text: ""});
        ...
        const level = this.add.uiElement(UIElementType.BUTTON, OldMainMenuLayers.PRIMARY, {position: new Vec2(center.x, center.y - 225), text: ""});
    ...
    protected initBackground(): void {
		...
		this.bg1 = this.add.sprite(OldMainMenu.BACKGROUND_KEY, OldMainMenuLayers.BACKGROUND);
